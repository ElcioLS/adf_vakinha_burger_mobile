...
class AuthService extends GetxService {
  ...
  Future<AuthService> init() async {
    _getStorage.listenKey(Constants.USER_KEY, (value) {
      ...
      //   _isLogged(false);
      // }
      // // reduzindo código fica assim como abaixo
    ...
    // final isLoggedData = getUserId() != null; //código básico
    // _isLogged(isLoggedData);                  //código básico
    //
    _isLogged(getUserId() != null); //código mais sucinto
    return this;
  }
